                        ...
                        var t = o(regeneratorRuntime.mark((function t(e) {
                            ...
                            return regeneratorRuntime.wrap((function(t) {
                                while (1) switch (t.prev = t.next) {
                                    case 0:
                                        return n = e.getProviderName, r = e.createLegacyProviderInterface, a = window.web3 && window.web3.currentProvider, t.abrupt("return", {
                                            provider: a,
                                            interface: a && "Coinbase" === n(a) ? r(a) : null
                                        });
                                    case 3:
                                    case "end":
                                        return t.stop()
