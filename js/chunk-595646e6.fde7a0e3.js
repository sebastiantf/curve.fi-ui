                        ...
                        var e = o(regeneratorRuntime.mark((function e(n) {
                            ...
                            return regeneratorRuntime.wrap((function(e) {
                                while (1) switch (e.prev = e.next) {
                                    case 0:
                                        return t = n.getProviderName, r = n.getAddress, a = n.getBalance, o = n.getNetwork, i = window.ethereum || window.web3 && window.web3.currentProvider, l = !1, e.abrupt("return", {
                                            provider: i,
                                            interface: i && void 0 === t(i) ? {
                                                name: "Opera Touch",
                                                connect: function() {
                                                    return i.enable().then((function(e) {
                                                        return l = !0, e
                                                    }))
                                                },
                                                address: {
                                                    get: function() {
                                                        return l ? r(i) : Promise.resolve(null)
                                                    }
                                                },
                                                network: {
                                                    get: function() {
                                                        return l ? o(i) : Promise.resolve(null)
                                                    }
                                                },
                                                balance: {
                                                    get: function() {
                                                        return l ? a(i) : Promise.resolve(null)
                                                    }
                                                }
                                            } : null
                                        });
...
//# sourceMappingURL=chunk-595646e6.fde7a0e3.js.map