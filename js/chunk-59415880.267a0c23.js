                ...
                return {
                    ...
                    wallet: function() {
                        var e = A(regeneratorRuntime.mark((function e(n) {
                            var r, a, c, o, i, u, s, f, h;
                            return regeneratorRuntime.wrap((function(e) {
                                while (1) switch (e.prev = e.next) {
                                    case 0:
                                        if (r = n.getProviderName, a = n.getAddress, c = n.getNetwork, o = n.getBalance, i = window.ethereum || window.web3 && window.web3.currentProvider, u = "MYKEY" === r(i), !u || !l) {
                                            e.next = 7;
                                            break
                                        }
                                                            ...
                                                            return regeneratorRuntime.wrap((function(e) {
                                                                while (1) switch (e.prev = e.next) {
                                                                    case 0:
                                                                        ...
                                                                        return h || (console.warn('The MYKEY provider does not allow rpc calls preventing Onboard.js from getting the balance. You can pass in a "rpcUrl" to the MYKEY wallet initialization object to get the balance.'), h = !0), e.abrupt("return", null);
                                                                    case 3:
                                                                        return e.next = 5, a(i);
                                                                    case 5:
                                                                        return n = e.sent, e.abrupt("return", o(f, n));
                                                                    case 7:
                                                                    case "end":
                                                                        return e.stop()
                                                                }
...
//# sourceMappingURL=chunk-59415880.267a0c23.js.map