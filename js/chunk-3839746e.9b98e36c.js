    ...
    ["chunk-3839746e"], {
        ...
        e01b: function(e, t, o) {
            ...
            var a = function() {
                    ...
                    })], 1), e._l(e.currencies, (function(t, a) {
                        return o("div", [o("volume-per-coin-stats", {
                            attrs: {
                                data: e.volumes[a],
                                currency: t,
                                loaded: e.loaded
                ...
                r = [],
                n = (o("99af"), o("cb29"), o("4de4"), o("4160"), o("caad"), o("c975"), o("d81d"), o("13d5"), o("b0c0"), o("b680"), o("4fad"), o("b64b"), o("d3b7"), o("07ac"), o("2532"), o("159b"), o("ddb0"), o("3835")),
                i = o("b85c"),
                s = o("ade3"),
                c = o("2909"),
                l = o("5530"),
            ...
            var O = new _.a,
                    ...
                    methods: {
                                    ...
                                    while (1) switch (t.prev = t.next) {
                                        ...
                                        case 3:
                                            return a = w["f"].volumeData[1440], a = Object.keys(a).reduce((function(e, t) {
                                                return Object(l["a"])({}, e, Object(s["a"])({}, t, new Array(Math.max.apply(Math, Object(c["a"])(Object.values(a).map((function(e) {
                                                    return e.length
                                                })))) - a[t].length).fill({}).concat(a[t])))
                                            }), {}), r = Object.keys(a).filter((function(t) {
                                                return e.piepools.includes(t)
                                            })).reduce((function(e, t) {
                                                return Object(l["a"])({}, e, Object(s["a"])({}, t, a[t]))
                                            }), {}), o = Object.entries(r), t.next = 9, S.getVolumePerCoin(r, o, k["g"]);
                                        case 9:
                                            e.volumes = t.sent;
                                        case 10:
                                        case "end":
                        ...
                        mounted: function() {
                            ...
                            return Object(p["a"])(regeneratorRuntime.mark((function t() {
                                ...
                                return regeneratorRuntime.wrap((function(t) {
                                    while (1) switch (t.prev = t.next) {
                                        case 0:
                                            console.log(e.volumes, "VOLUMES");
                                            while (e.chart && e.chart.series[0]) e.chart.series[0].remove();
                                            o = Object(i["a"])(e.volumes.entries());
                                            try {
                                                for (o.s(); !(a = o.n()).done;) r = Object(n["a"])(a.value, 2), s = r[0], c = r[1], e.chart.addSeries({
                                                    name: e.currencies[s],
                                                    data: c
                                                }, !1, !1)
                                            } catch (l) {
                        ...
                        loadPieChart: function() {
                            ...
                            this.piechart.showLoading(), this.piechart.series[0] && this.piechart.series[0].remove(), this.piechart.update({
                                title: {
                                    text: "Share of trading volume per coin for ".concat("all" != this.period ? "last " + this.period : "all time")
                                }
                            }, !1);
                            var t = {
                                    day: 864e5,
                            ...
                            var i = n.map((function(e) {
                                return e.y
                            })).indexOf(Math.max.apply(Math, Object(c["a"])(n.map((function(e) {
                                return e.y
                            })))));
                            n[i].sliced = !0, n[i].selected = !0, this.piechart.addSeries({
                                name: "Trading Volume %",
                                data: n
                ...
                T = P,
                j = (o("da04"), o("2877")),
                L = Object(j["a"])(T, a, r, !1, null, "447f3087", null);
            t["default"] = L.exports
        }
    }
]);
//# sourceMappingURL=chunk-3839746e.9b98e36c.js.map