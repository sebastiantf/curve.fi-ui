(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["chunk-2d0ced66"], {
        "60c9": function(t, n, e) {
            ...
            e("f6b3");
            var l = e("080d");
            e("901e"), e("fd33"), e("337f");

            function c(t, n, e, l, c, r, i) {
                try {
                    var a = t[r](i),
                        o = a.value
                } catch (d) {
                ...
                a.done ? n(o) : Promise.resolve(o).then(l, c)
            }
                        ...
                        var t = r(regeneratorRuntime.mark((function t(r) {
                            ...
                            return regeneratorRuntime.wrap((function(t) {
                                while (1) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, e.e("chunk-2d0b93f9").then(e.t.bind(null, "31af", 7));
                                    case 2:
                                        return i = t.sent, a = i["default"], o = new a(n, Object(l["f"])(c)), d = o.provider, f = r.BigNumber, t.abrupt("return", {
                                            provider: d,
                                            instance: o,
                                            interface: {
                                                name: "Portis", connect: d.enable, disconnect: function() {
                                                    o.logout(), d.stop()
                                                }, address: {
                                                    onChange: function(t) {
                                                        o.onLogin((function(n) {
                                                            t(n), d.address = n
                                                        }))
                                                    }
                                                }, network: {
                                                    get: function() {
                                                        return Promise.resolve(Number(o.config.network.chainId))
                                                    }
                                                }, balance: {
                                                    get: function() {
                                                        return new Promise((function(t) {
                                                            setTimeout((function() {
                                                                d.address ? d.sendAsync({
                                                                    jsonrpc: "2.0",
                                                                    method: "eth_getBalance",
                                                                    params: [d.address, "latest"],
                                                                    id: 1
                                                                }, (function(n, e) {
                                                                    t(f(e.result).toString(10))
                                                                })) : t(null)
                                                            }), 1)
                                                        }))
                                                    }
                                                }, dashboard: function() {
                                                    return Object(l["g"])("https://wallet.portis.io/")
                                                }
                                            }
                                        });
                                    case 8:
...
//# sourceMappingURL=chunk-2d0ced66.341312a6.js.map